...
const { getBookByISBN } = require('./booksdb'); // Import the function
const { getBooksByAuthor } = require('./booksdb');
const { getBooksByTitle } = require('./booksdb');
const { getBookReviewByISBN } = require('./booksdb');
...
public_users.get('/', function (req, res) {
  ...
  const availableBooks = booksArray.filter(book => book);
